...
<section class="content-header">
  <h1>
    <i class="fa fa-desktop icon-title"></i> user
      ...
      <div class="box box-primary">
        <div class="box-body">
          ...
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_user ORDER BY user_id DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='150'>$data[fullname]</td>
                      <td width='150'>$data[email]</td>
                      ";
                      if(empty($data['avatar'])){
                        echo "<td width='200' class='center'>
                        Foto Kosong
                      </td>";
                      }else{
                        echo " <td width='200' class='center'>
                        <img src='../images/user/$data[avatar]' height='150'>
                      </td>";
                      }
                      echo"
                      ...
                      <td class='center' width='80'>
                        <div>
                          <a data-toggle='tooltip' data-placement='top' title='Change' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_user&form=edit&id=$data[user_id]'>
                              <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                          </a>";
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-danger btn-sm" href="modules/user/proses.php?act=delete&id=<?php echo $data['user_id']?>&namafile=<?php echo $data['avatar'] ?>" onclick="return confirm('Are you sure you want to delete <?php echo $data['username']; ?> ?');">
