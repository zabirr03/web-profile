<section class="content-header">
  <h1>
    <i class="fa fa-desktop icon-title"></i> Category Materi
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="records_content_materi"></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="addRecordMateri()">Add Record</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="update_materi_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" onclick="UpdateCategoryDetailsMateri()" >Save Changes</button>
                <input type="hidden" id="hidden_materi_id">
            </div>
        </div>
    </div>
</div>
