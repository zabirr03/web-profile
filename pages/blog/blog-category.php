    ...
    <section class="bottom-50 root-sec grey lighten-5 blogpage-posts-wrap">
      <div class="container">
        <div class="row">
          ...
          <?php 
        $query=mysqli_query($mysqli,"SELECT * FROM is_article a ,is_category_article b WHERE a.is_category_article_id=b.category_article_id  AND a.is_category_article_id='$_GET[id]'  LIMIT 9");
